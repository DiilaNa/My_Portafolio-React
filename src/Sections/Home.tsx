          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative lg:flex justify-center hidden animate-fade-in">
              <div className="relative">
                {/!* Glow effect *!/}
                <div
                    className="absolute inset-0 bg-gradient-to-r from-primary to-accent rounded-full blur-3xl opacity-30 animate-pulse"/>

                {/!* Image container *!/}
                <div
                    className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-primary/30 shadow-2xl">
                  <img
                      src={profileImage}
                      alt="Profile"
                ...
                {/!* Decorative elements *!/}
                <div
                    className="absolute -top-4 -right-4 w-20 h-20 bg-accent rounded-full blur-xl opacity-60 animate-float"/>
                <div
                    className="absolute -bottom-4 -left-4 w-24 h-24 bg-primary rounded-full blur-xl opacity-60 animate-float-delayed"/>
              </div>
            </div>
          </div>
        </div>
