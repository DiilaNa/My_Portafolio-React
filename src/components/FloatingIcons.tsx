...
const icons = [
    ...
    { Icon: SiJavascript, delay: "2s", position: "top-[60%] left-[5%]" },
    ...
    { Icon: SiMongodb, delay: "0.8s", position: "top-[70%] right-[12%]" },
    { Icon: SiPostgresql, delay: "1.8s", position: "bottom-[40%] left-[15%]" },
    { Icon: SiSpring, delay: "2.2s", position: "top-[25%] left-[18%]" },
    { Icon: SiHtml5, delay: "1.2s", position: "bottom-[25%] right-[18%]" },
